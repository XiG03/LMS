...
{
    /// <inheritdoc />
    public partial class AddMockDatabase : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ParentStudentLinks_AspNetUsers_StudentId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AIUsagePercent = table.Column<decimal>(type: "decimal(5,2)", nullable: false),
                    SuggestedScore = table.Column<decimal>(type: "decimal(5,2)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    SubmissionId = table.Column<int>(type: "int", nullable: false),
                    GradedByTeacherId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Grades_AspNetUsers_GradedByTeacherId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_StudentLinkCode",
                table: "AspNetUsers",
                column: "StudentLinkCode",
                unique: true,
                filter: "[StudentLinkCode] IS NOT NULL");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClassEnrollments_ClassId_UserId",
